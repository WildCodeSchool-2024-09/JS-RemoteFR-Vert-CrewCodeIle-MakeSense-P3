...
INSERT INTO decision (title, min_date, max_date, description, context, profit, risk, step, user_id, country_id) 
VALUES ("Title test", "2024-03-01", "2024-12-16", "Description test", "Context test", "Profit test", "Risk test", "Steps test", 1, 1);